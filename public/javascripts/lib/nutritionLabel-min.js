...
(function($) {
    ...
    function UpdateNutritionValueWithMultiplier(settings) {
        var nutritionIndex = ["valueCalories", "valueFatCalories", "valueTotalFat", "valueSatFat", "valueTransFat", "valuePolyFat", "valueMonoFat", "valueCholesterol", "valueSodium", "valueTotalCarb", "valueFibers", "valueSugars", "valueProteins", "valueVitaminA", "valueVitaminC", "valueCalcium", "valueIron"];
        $.each(settings, function(index, value) {
    ...
    function changeQuantityTextbox($thisTextbox, $originalSettings, nutritionLabel, $elem) {
        ...
        textBoxValue = isNaN(textBoxValue) ? 1 : textBoxValue;
    ...
    NutritionLabel.prototype = {
        generate: function() {
            ...
            if ($this.settings.showServingUnitQuantity) {
                ...
                if ($this.settings.originalServingUnitQuantity > 0) {
                    ...
                    if ($this.settings.valueServingWeightGrams > 0) {
                        nutritionLabel += tab3 + '<div class="servingWeightGrams fl ' + gramsAddedClass + '">(' + parseFloat($this.settings.valueServingWeightGrams.toFixed($this.settings.decimalPlacesForNutrition)) + "g)</div>\n"
                    }
            ...
            if ($this.settings.showTotalFat) {
                ...
                nutritionLabel += $this.settings.naTotalFat ? naValue : "<b>" + parseFloat(parseFloat((($this.settings.allowFDARounding ? roundFatRule($this.settings.valueTotalFat) : $this.settings.valueTotalFat) / ($this.settings.dailyValueTotalFat * calorieIntakeMod)) * 100).toFixed($this.settings.decimalPlacesForDailyValues)) + "</b>%";
                nutritionLabel += "</div>\n";
            ...
            if ($this.settings.showSatFat) {
                ...
                nutritionLabel += tab2 + '<div class="dv">';
                nutritionLabel += $this.settings.naSatFat ? naValue : "<b>" + parseFloat(parseFloat((($this.settings.allowFDARounding ? roundFatRule($this.settings.valueSatFat) : $this.settings.valueSatFat) / ($this.settings.dailyValueSatFat * calorieIntakeMod)) * 100).toFixed($this.settings.decimalPlacesForDailyValues)) + "</b>%";
                nutritionLabel += "</div>\n";
            ...
            if ($this.settings.showCholesterol) {
                nutritionLabel += tab1 + '<div class="line">\n';
                nutritionLabel += tab2 + '<div class="dv">';
                nutritionLabel += $this.settings.naCholesterol ? naValue : "<b>" + parseFloat(parseFloat((($this.settings.allowFDARounding ? roundCholesterolRule($this.settings.valueCholesterol) : $this.settings.valueCholesterol) / ($this.settings.dailyValueCholesterol * calorieIntakeMod)) * 100).toFixed($this.settings.decimalPlacesForDailyValues)) + "</b>%";
                nutritionLabel += "</div>\n";
            ...
            if ($this.settings.showSodium) {
                nutritionLabel += tab1 + '<div class="line">\n';
                nutritionLabel += tab2 + '<div class="dv">';
                nutritionLabel += $this.settings.naSodium ? naValue : "<b>" + parseFloat(parseFloat((($this.settings.allowFDARounding ? roundSodiumRule($this.settings.valueSodium) : $this.settings.valueSodium) / ($this.settings.dailyValueSodium * calorieIntakeMod)) * 100).toFixed($this.settings.decimalPlacesForDailyValues)) + "</b>%";
                nutritionLabel += "</div>\n";
            ...
            if ($this.settings.showTotalCarb) {
                nutritionLabel += tab1 + '<div class="line">\n';
                nutritionLabel += tab2 + '<div class="dv">';
                nutritionLabel += $this.settings.naTotalCarb ? naValue : "<b>" + parseFloat(parseFloat((($this.settings.allowFDARounding ? roundCarbFiberSugarProteinRule($this.settings.valueTotalCarb) : $this.settings.valueTotalCarb) / ($this.settings.dailyValueCarb * calorieIntakeMod)) * 100).toFixed($this.settings.decimalPlacesForDailyValues)) + "</b>%";
                nutritionLabel += "</div>\n";
